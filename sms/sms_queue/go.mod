...
require (
	...
	tycoon.systems/tycoon-services/sms/sms_utility v0.0.0-00010101000000-000000000000
...
require (
	...
	tycoon.systems/tycoon-services v0.0.0-00010101000000-000000000000 // indirect
	tycoon.systems/tycoon-services/security v0.0.0-00010101000000-000000000000 // indirect
	tycoon.systems/tycoon-services/sms/sms_queue/workers v0.0.0-00010101000000-000000000000 // indirect
)
...
replace tycoon.systems/tycoon-services/sms/sms_queue/workers => /workers

replace tycoon.systems/main => ../../

replace tycoon.systems/tycoon-services/security => /../../security

replace tycoon.systems/tycoon-services/sms => ../
